...
<body>
    <div class="container" style="margin-top: 40px; width:500px">
        ...
        <form action="_pesquisar_produto.php" method="POST" style="margin-top: 20px;">
           
            <div class="form-group">
                <label>Pesquisar</label>
                <input name="pesquisar" type="text" class="form-control" placeholder="Insira o nome do produto" autocomplete="off" required>
            </div>
